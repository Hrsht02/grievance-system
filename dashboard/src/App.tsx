...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/officer" element={<RequireAuth role="officer"><OfficerDashboard /></RequireAuth>} />
      <Route path="/officer/complaints/:id" element={<RequireAuth role="officer"><ComplaintDetail /></RequireAuth>} />
